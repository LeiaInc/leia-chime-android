 ...
 */
class LeiaCameraCaptureSourceNotWorking @JvmOverloads constructor(
    ...
    private val MAX_INTERNAL_SUPPORTED_FPS = 30
    private val DESIRED_CAPTURE_FORMAT = VideoCaptureFormat(960, 1440, MAX_INTERNAL_SUPPORTED_FPS)
...
//    var blinkSurfaceTexture: SurfaceTexture =
//        SurfaceTexture(false).apply { setDefaultBufferSize(width, height) }
//    var blinkSurface = Surface(blinkSurfaceTexture)

    var cpuImageReader: ImageReader = ImageReader.newInstance( 3264, 2448,
    ...
    override fun start() {
        ...
        val chosenCaptureFormat: VideoCaptureFormat? = DESIRED_CAPTURE_FORMAT
...
//
//
//        val captureRequestBuilder1 =
//            cameraDevice.createCaptureRequest(CameraDevice.TEMPLATE_PREVIEW)
//
//        captureRequestBuilder1.addTarget( cpuImageReader.surface)
////        cameraCaptureSession?.stopRepeating()
//        cameraCaptureSession?.capture(captureRequestBuilder1.build(), object : CameraCaptureSession.CaptureCallback() {
